...
public class BlockchainSimulator {
    ...
    public static void main(String args[]) throws InterruptedException, IOException {
        ...
        //System.out.println("Chunk Size (KB):"+Sharables.ChunkSize/(1024*8));
        System.out.print("No_of_nodes\t");
        System.out.print("Chunks Size(KB)\t");
        System.out.print("Propagation time(millis)\n");
        System.out.println("--------------------------------------------------------------------------");

        int NoOfNodes = 65536;
        long Blocksize = 64*1024 * 8 * 1024; //16 KB
        ...
        for (int k = 0; k < 1; k++) { //iterate no of nodes
            ...
            for (int l = 0; l < 14; l++) { //iterate blocksize
                ...
                System.out.print(Sharables.ChunkSize / (1 * 8 * 1024) + "\t");
                System.out.print(Sharables.MaxTimeTaken + "\t\n");

                //Blocksize *= 2;
                Sharables.ChunkSize *= 2;
